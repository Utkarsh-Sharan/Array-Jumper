...
namespace Level
{
	...
	void LevelView::deleteImages()
	{
		...
		box_image = nullptr;
		target_overlay_image = nullptr;
		letter_one_overlay_image = nullptr;
		letter_two_overlay_image = nullptr;
		letter_three_overlay_image = nullptr;
		obstacle_one_overlay_image = nullptr;
		obstacle_two_overlay_image = nullptr;
